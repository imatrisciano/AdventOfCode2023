...
class Card
{
	private static readonly List<char> CardOrdering = ['2','3','4','5','6','7','8','9','T','J','Q','K','A'];
...
class Hand
{
	...
	{
		var CardGroups = Cards.GroupBy(x=>x.CardSymbol).OrderByDescending(x=>x.Count()).ToList(); // sort the card groups by # of occurences (descending)
		...
		else if (numberOfDifferentCards == 2)
		{
			...
			if (maxOccurencesOfAnyCard == 4)
				return HandTypes.FourOfAKind;
			else if (maxOccurencesOfAnyCard == 3)
			{
